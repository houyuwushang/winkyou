...
- post-bound improvement still needs a working signaling path until in-band re-ICE or another peer-control transport is wired; it does not make first bootstrap coordinator-less
