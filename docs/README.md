...
- Gate C1b composition is paused for the unaccepted bilateral-FINISH/OOB-close proposal in ADR §19; the root execution decision (§18), failing required CI and outstanding real SSH/netns gates are recorded explicitly: [`GATE-C1B-PRODUCT-COMPOSITION-EVIDENCE.md`](./GATE-C1B-PRODUCT-COMPOSITION-EVIDENCE.md)
