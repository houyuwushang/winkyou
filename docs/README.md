...
- Draft N2d dual-process namespace/NAT-lab composition proof (test-only, required Linux CI; no product/live-network authority): [`N2D-NAMESPACE-E2E.md`](./N2D-NAMESPACE-E2E.md)
