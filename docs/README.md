...
- Draft C1c prerequisite session-liveness re-adjudication: retain WireGuard, propose bounded bilateral in-tunnel challenges, per-write expiry and separate control budgets; protocol/timing choices remain unaccepted and no implementation or field I/O is authorized: [`adr/ADR-N3C-SESSION-LIVENESS.md`](./adr/ADR-N3C-SESSION-LIVENESS.md)
