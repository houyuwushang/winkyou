...
- Accepted first non-loopback connect-test authority boundary and Draft N1 netns proof (mandatory Linux CI; no N2/N3 or live-network authorization): [`adr/ADR-NON-LOOPBACK-CONNECT-TEST-BOUNDARY.md`](./adr/ADR-NON-LOOPBACK-CONNECT-TEST-BOUNDARY.md), [Issue #70](https://github.com/houyuwushang/winkyou/issues/70)
