...
- Accepted Hard16 mapping-lifetime adjudication (D1–D6): M implementation authorized 2026-09-07 in Draft #107 (60s stable / 30s expiry / isolated injections, namespace restoration, preserved RED evidence); first OS matrix acceptance is pending and early-stop/live I/O remain gated: [`adr/ADR-N3C-HARD16-MAPPING-LIFETIME.md`](./adr/ADR-N3C-HARD16-MAPPING-LIFETIME.md), [`GATE-B3-HARD16-ISOLATED-EVIDENCE.md §11`](./GATE-B3-HARD16-ISOLATED-EVIDENCE.md#11-107-m-实现与首跑记录2026-09-07draft), [Issue #106](https://github.com/houyuwushang/winkyou/issues/106)
