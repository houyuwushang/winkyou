...
- Draft N2c disconnected governed rendezvous carrier and same-socket STUN evidence (literal loopback only; no product/live-network authority): [`N2C-RENDEZVOUS-CARRIER.md`](./N2C-RENDEZVOUS-CARRIER.md)
