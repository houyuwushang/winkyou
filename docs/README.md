...
- C1c-2a endpoint field build (independent review pending): exact-SHA `fieldc1c`, opaque SSH/UDP/TUN authority, strict private 88-field instance and required isolated proof; no field-window authorization: [`adr/ADR-N3C-GATE-C1C-DISPOSABLE-ROUTER.md`](./adr/ADR-N3C-GATE-C1C-DISPOSABLE-ROUTER.md), [`GATE-C1C-FIELD-BUILD-EVIDENCE.md`](./GATE-C1C-FIELD-BUILD-EVIDENCE.md).
