...
- Accepted Gate C1 design for a fixed, key-only OpenSSH child stream and product handoff. Gate C1a and independently reviewed C1b are merged; C1b evidence is limited to memory, literal loopback and required netns. C1c-2 implementation is separately authorized by the disposable-router mini-spec; C1c-3/C2 and live I/O remain unauthorized: [`adr/ADR-N3C-GATE-C1-SSH-PRODUCT-ASSEMBLY.md`](./adr/ADR-N3C-GATE-C1-SSH-PRODUCT-ASSEMBLY.md), [`GATE-C1A-SSH-ASSEMBLY-EVIDENCE.md`](./GATE-C1A-SSH-ASSEMBLY-EVIDENCE.md), [`N3C-GATE-C-LIVE-AUTHORIZATION-TEMPLATE.md`](./N3C-GATE-C-LIVE-AUTHORIZATION-TEMPLATE.md), [Issue #98](https://github.com/houyuwushang/winkyou/issues/98)
- C1c-2a endpoint field build (independently reviewed and merged): exact-SHA `fieldc1c`, opaque SSH/UDP/TUN authority, strict private `/1` instance and required isolated proof; no field-window authorization: [`adr/ADR-N3C-GATE-C1C-DISPOSABLE-ROUTER.md`](./adr/ADR-N3C-GATE-C1C-DISPOSABLE-ROUTER.md), [`GATE-C1C-FIELD-BUILD-EVIDENCE.md`](./GATE-C1C-FIELD-BUILD-EVIDENCE.md).
- C1c-2b router/observer tool (implementation and isolated acceptance in progress): explicit unified `/2`, owned NAT domains, private RFC 5780/conntrack witnesses and teardown; no C1c-3 grant: [`GATE-C1C-ROUTER-EVIDENCE.md`](./GATE-C1C-ROUTER-EVIDENCE.md), [empty router field catalog](./templates/gate-c1c-router-v2.template.json).
- Gate C1b implementation independently reviewed and merged in [PR #104](https://github.com/houyuwushang/winkyou/pull/104) (`f2df745`), under accepted R1 (§19) and root execution (§18): successful memory, real SSH/netns/TUN and bounded-fault evidence, with original failures preserved: [`GATE-C1B-PRODUCT-COMPOSITION-EVIDENCE.md`](./GATE-C1B-PRODUCT-COMPOSITION-EVIDENCE.md)
- Accepted C1c prerequisite session-liveness re-adjudication: WireGuard, bounded bilateral challenges (K=20s/R=5s/M=2|3), per-write expiry and separate budgets. Draft #112 implements isolated proofs; §12 records the maintainer's admission-rejection decision A and ten implementation choices. C1c and field I/O remain separately gated: [`adr/ADR-N3C-SESSION-LIVENESS.md`](./adr/ADR-N3C-SESSION-LIVENESS.md), [`GATE-C-LIVENESS-EVIDENCE.md`](./GATE-C-LIVENESS-EVIDENCE.md)
...
- Accepted Hard16 mapping-lifetime adjudication (D1–D6): authorized M implementation in Draft #107 has 18/18 isolated OS campaigns and 35/35 CI at its measured code head (60s stable / 30s expiry / two injection points, namespace restoration, preserved RED evidence); independent review remains pending, early-stop/live I/O remain gated: [`adr/ADR-N3C-HARD16-MAPPING-LIFETIME.md`](./adr/ADR-N3C-HARD16-MAPPING-LIFETIME.md), [`GATE-B3-HARD16-ISOLATED-EVIDENCE.md §11`](./GATE-B3-HARD16-ISOLATED-EVIDENCE.md#11-107-m-实现与首跑记录2026-09-07draft), [Issue #106](https://github.com/houyuwushang/winkyou/issues/106)
- Draft Hard16 E2 early-confirmation mini-spec: eight-frame accounting, bilateral proposals, stop/receive ownership, compatibility amendments and unexecuted acceptance gates; no implementation authorization: [`adr/ADR-N3C-HARD16-EARLY-CONFIRMATION.md`](./adr/ADR-N3C-HARD16-EARLY-CONFIRMATION.md)
