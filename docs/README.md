...
- Gate C1b Draft implementation under accepted R1 (§19) and root execution (§18): successful memory, real SSH/netns/TUN and bounded-fault evidence, preserved failures, and pending independent review: [`GATE-C1B-PRODUCT-COMPOSITION-EVIDENCE.md`](./GATE-C1B-PRODUCT-COMPOSITION-EVIDENCE.md)
