...
- `candidate_kept_samples` 和 `candidate_rejected_samples`：少量候选样本。用这些字段直接对比 natpierce 日志里的公网 endpoint；如果 WinkYou 只看到 `host:100.64...` 或私网样本，说明它还没有采到同级别的公网 srflx/prflx 候选。
