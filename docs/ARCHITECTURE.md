...
| TASK-04 | NAT穿透模块 | [tasks/TASK-04-nat-traversal.md](tasks/TASK-04-nat-traversal.md) | 高 | TASK-01 |
...
| Phase 2 | TASK-04, TASK-07 | 跨NAT自动连接 |
| Phase 3 | TASK-05 | 自动节点发现 |
| Phase 4 | TASK-06 | MVP完整客户端 |
...
type CoordinatorClient interface {
    ...
    // 信令
    SendSignal(ctx context.Context, toNodeID string, signal []byte) error
...
wink:
  ...
  wireguard:
    private_key: "..."
    listen_port: 51820
    cipher_suite: "auto"  # auto|chacha20|aes128|aes256 (见 wink-protocol-v1.md)
...
**A:** 部分可以：
- TASK-01 必须最先完成（基础设施）
- TASK-02, TASK-04, TASK-05, TASK-07 可以并行（依赖TASK-01）
- TASK-03 依赖 TASK-02
- TASK-06 依赖所有其他任务
